...
public class Treasure : MonoBehaviour {
	...
	void Update () {
		...
		if (WinPos.position.y < -18.5f) {
			MistyText.text = "Yooooo what's uuuuuup dude! \nOh maaan Jenna's party? Umm... \nWe know it's not like, in any of the 4 2 roOms... we're having a LAN party with the dudes in those rooms hahaha \nBest of luck yo!";

		}
		if (WinPos.position.x < -19.0f) {
